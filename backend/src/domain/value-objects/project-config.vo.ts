...
export class ThemeConfig {
  ...
  equals(other: ThemeConfig): boolean {
    return this._primaryColor === other._primaryColor &&
...
export class NavigationConfig {
  ...
  get menuItems(): ReadonlyArray<{ label: string; path: string }> { return this._menuItems; }
...
export class ProjectConfig {
  ...
  equals(other: ProjectConfig): boolean {
    const navigationEquals = this._navigation && other._navigation 
